      ...
      <Router>
        ...
        <div className="router-view">
          <Routes>
            ...
            <Route path="/meals" element={<PrivateRoute element={<ListMealComponent />} allowedRoles={['ADMIN', 'EMPLOYEE']} />} />
            <Route path="/menu" element={<MenuMealTypeComponent />} />
            <Route path="/meal-types" element={<PrivateRoute element={<ListMealTypeComponent />} allowedRoles={['ADMIN', 'EMPLOYEE']} />} />
