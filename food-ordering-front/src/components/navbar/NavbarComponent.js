     ...
     <div className='header'>
          ...
          <div className='nav-links-buttons-container'>
               ...
               {(localStorage.role ==="ADMIN" || localStorage.role ==="USER" || localStorage.role ==="EMPLOYEE") && <div className='navMenu'>
                    ...
                    {localStorage.role==="ADMIN" || localStorage.role==="EMPLOYEE" && <Link className='navLink' to='/meals' >
                         Meals
                    </Link>}
                    {localStorage.role==="ADMIN" || localStorage.role==="EMPLOYEE" && <Link className='navLink' to='/meal-types' >
                         Meal types
                    </Link>}
